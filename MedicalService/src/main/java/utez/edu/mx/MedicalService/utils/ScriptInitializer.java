...
public class ScriptInitializer {
    ...
    public void init() {
        ...
        if (checkIfTableIsEmpty("users")) {
            jdbcTemplate.execute("INSERT INTO `users` (`email`, `fisrt_surname`, `name`, `password`, `phone`, `second_surname`, `id_rol`, `id_status`) VALUES ('20213tn042@utez.edu.mx', 'Santander', 'Omar de Jesus', '$2a$10$guSF3YkYTLX2JHjmXjH0K.sVzZxAv1GTFDg8jWTN2xERBJUdNAlPO', '7775196369', 'Verdayes', '1', '1'), ('20213tn043@utez.edu.mx', 'Santana', 'mendoza', '$2a$10$Hv8DF3vP5h/IhyU.TTMpDuVB8TZ4Q5TpY2dgkrMdlguIEG.6LCn3e', '7775196369', 'Mendoza', '2', '1'),('20213tn044@utez.edu.mx', 'Diaz', 'Andrea Elizabeth', '$2a$10$IZRalDZ82KkgwkYXXmlCyOhvjkDgglys.DzN5eikBYOdp5ieGK7bq', '7775196369', 'Zagal', '3', '1');");
        }
