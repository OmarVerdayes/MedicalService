...
public class RolesController {
    ...
    @PostMapping("/")
    public ResponseEntity<CustomResponse<Roles>> insert(@Validated @RequestBody RolesDTO rolesDTO){
        return new ResponseEntity<>(this.service.insert(rolesDTO),HttpStatus.CREATED);
    }
    @PutMapping("/")
    public ResponseEntity<CustomResponse<Roles>> update(@Validated @RequestBody RolesDTO rolesDTO){
        return new ResponseEntity<>(this.service.update(rolesDTO),HttpStatus.CREATED);
    }
    @DeleteMapping("/")
