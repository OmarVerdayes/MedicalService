...
public class AppointmentStatusController {
    ...
    @PostMapping("/")
    public ResponseEntity<CustomResponse<AppointmentStatus>> insert(@Validated @RequestBody AppointmentStatusDTO appointmentStatusDTO){
        return new ResponseEntity<>(this.service.insert(appointmentStatusDTO),HttpStatus.CREATED);
    }
    @PutMapping("/")
    public ResponseEntity<CustomResponse<AppointmentStatus>> update(@Validated @RequestBody AppointmentStatusDTO appointmentStatusDTO){
        return new ResponseEntity<>(this.service.update(appointmentStatusDTO),HttpStatus.CREATED);
    }
    @DeleteMapping("/")
